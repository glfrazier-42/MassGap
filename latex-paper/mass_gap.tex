...
predicts additional deficit from spin-induced $M_g$ reduction,
...
The singularity model curve (red, dashed) uses the spinning GR
formula (Eq.~\ref{eq:frac_gr}), evaluated at the sample median
$\chi_{\rm eff} = \gwMedianChiEff$.  The quark star model curve (purple,
...
($\rho = \gwRhoExcessChif$, $p = \gwPExcessChif$ for Test~1).
