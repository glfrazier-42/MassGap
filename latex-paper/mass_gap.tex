...
The singularity-model baseline in Eq.~\ref{eq:frac_gr} uses the Kerr
ISCO binding energy evaluated at each event's $\chi_{\rm eff}$
\citep{BardeenPressTeukolsky1972}.  For the GWTC sample the median
$\chi_{\rm eff} = \gwMedianChiEff$, and the spin correction is less
than $1\%$ of the baseline.  Both tests are highly significant
