...
\input{tables/pulsar_macros}
\input{tables/population_macros}
\input{tables/merger_macros}
\input{tables/eta_confound_macros}
...
\subcaptionbox{Gravitational Mass vs. Radius\label{fig:tov_mr}}{
  \includegraphics[width=0.5\linewidth]{figures/tov_mass_radius.png}
}\hfill
\subcaptionbox{Gravitational Mass vs. Baryonic Mass\label{fig:tov_mg_mb}}{
  \includegraphics[width=0.37\linewidth]{figures/tov_mg_vs_mb.png}
}
...
$1.18$--$2.74\;\Msun$ and includes four binary categories: NS--WD
(21 systems), NS--NS (7), X-Ray/Optical (2), and NS--MS (3).  Three
of the most precisely measured high-mass pulsars---J0740+6620
($2.08 \pm 0.07\;\Msun$; \citealt{Cromartie2020}), J0348+0432
($2.01 \pm 0.04\;\Msun$), and J1614$-$2230
($1.928 \pm 0.017\;\Msun$)---anchor the high end of the
distribution.
...
controlled by~$\eta$.  We use the spinning-GR prediction as a
baseline, extending \citet{BuonannoKidderLehner2008} by replacing the
Schwarzschild ISCO binding energy with its Kerr analogue
\citep{BardeenPressTeukolsky1972}:
%
...
\begin{figure}[t]
  \centering
  \includegraphics[width=\columnwidth]{figures/bh_merger_excess_vs_chif_v2.png}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=\columnwidth]{figures/bh_merger_deficit_per_m2_v2.png}
